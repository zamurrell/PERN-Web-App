...
export const ListingCreateBookingModal = ({
  ...
  const handleCreateBooking = async () => {
    if (!stripe) {
      return displayErrorMessage("We weren't able to connect with Stripe.");
    }
      ...
      createBooking({
        variables: {
          input: {
            ...
            checkIn: moment(checkInDate).format("YYY-MM-DD"),
            checkOut: moment(checkOutDate).format("YYY-MM-DD"),
          },
        },
      });
    } else {
